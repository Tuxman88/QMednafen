...
#include "../src/gui/menubar/menubar.h"
...
static const char qt_meta_stringdata_Gui__MenuBar[] = {
    "Gui::MenuBar\0"
};
...
const QMetaObjectExtraData Gui::MenuBar::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Gui::MenuBar::staticMetaObject = {
    { &QMenuBar::staticMetaObject, qt_meta_stringdata_Gui__MenuBar,
      qt_meta_data_Gui__MenuBar, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Gui::MenuBar::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Gui__MenuBar))
